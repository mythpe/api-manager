...
/**
 * Class MakeManagerTransformerCommand
 * @package Myth\Api\Commands
 */
class MakeManagerTransformerCommand extends BaseCommand
{
     ...
     * @var string
     */
    protected $signature = 'myth:make-manager-transformer {name : The name of the transformer}';
    ...
    function getStub()
    {
        return $this->fs->get($this->stubPath('manager-transformer'));
    }
